...
class PiecesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create piece" do
    assert_difference('Piece.count') do
      post pieces_url, params: { piece: { artist_name: @piece.artist_name, height: @piece.height, length: @piece.length, title: @piece.title, width: @piece.width, year: @piece.year } }
    end
  ...
  test "should update piece" do
    patch piece_url(@piece), params: { piece: { artist_name: @piece.artist_name, height: @piece.height, length: @piece.length, title: @piece.title, width: @piece.width, year: @piece.year } }
